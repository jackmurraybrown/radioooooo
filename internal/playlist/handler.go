...
func (h *Handler) Register(api huma.API) {
	huma.Register(api, huma.Operation{
		...
		Path:          "/stations/{stationId}/playlists",
	...
	huma.Register(api, huma.Operation{
		...
		Method:      http.MethodGet,
		Path:        "/stations/{stationId}/playlists/{id}",
	...
	huma.Register(api, huma.Operation{
		...
		Method:        http.MethodPost,
		Path:          "/stations/{stationId}/playlists/{id}/items",
	...
	huma.Register(api, huma.Operation{
		...
		Method:        http.MethodDelete,
		Path:          "/stations/{stationId}/playlists/{id}/items/{itemId}",
...
func (h *Handler) get(ctx context.Context, input *playlistInput) (*playlistWithItemsOutput, error) {
	stationID, ok := auth.StationIDFromContext(ctx)
	if !ok || stationID != input.StationID {
		return nil, huma.Error403Forbidden("forbidden")
	}
...
func (h *Handler) delete(ctx context.Context, input *playlistInput) (*struct{}, error) {
	stationID, ok := auth.StationIDFromContext(ctx)
	if !ok || stationID != input.StationID {
		return nil, huma.Error403Forbidden("forbidden")
	}
